<?php 
  ...
  $arrayForm = [
    ...
    [
      'label' => Helper::createLabel('answer'),
      'input' => Helper::createInput('text','form[answer]',$form['answer']??'','Answer',$this->errors['answer']??'')
    ],
    [
      'label' => Helper::createLabel('question'),
      'input' => Helper::createInput('text','form[question]',$form['question']??'','Question',$this->errors['question']??'')
    ],
    [
