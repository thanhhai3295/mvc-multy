              ...
              <table class="table table-hover table-bordered">
                  <thead>
                    <tr>
                        ...
                        <th><?php echo $lblQuestion ?></th>
                        <th><?php echo $lblAnswer ?></th>
                  ...
                  <?php 
                    ...
                    if (!empty($this->items)) {
                      foreach ($this->items as $key => $value) {
                        ...
                        $question = HTML::addSpan($value['question']);
                        $answer   = HTML::addSpan($value['answer']);
                        $urlForm  = URL::createLink('admin','faq','form',['id' => $value['id']]);
                        $urlDelete = URL::createLink('admin','faq','delete',['id' => $value['id']]);
                        $xhtml .= '<tr>
                                    <td>
                                      <div class="icheck-danger d-inline">
